...
import { ref } from 'vue'
import type { model회원회비 as modelXX } from '~models/test2'
import { model회원회비s as modelXXs, model회원s, model결제s } from '~models/test2'
...
await do첫조회('member-fees', () => Promise.all([
  XXs.reads(),
