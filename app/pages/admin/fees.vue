...
import { ref } from 'vue'
import type { model회비 as modelXX } from '~models/test2'
import { model회비s as modelXXs, model회원회비s, model회원s, model결제s } from '~models/test2'
